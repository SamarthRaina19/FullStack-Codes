...
export default function Dashboard() {
  ...
  const skills = [
    ...
    {
      name: "Python",
      desc: "Used for scripting, automation and AI/ML basics.",
    },
    {
      name: "HTML",
      desc: "Builds structure of web pages using semantic tags.",
    },
    {
      name: "CSS",
      desc: "Design UI using flexbox, grid and responsive layout.",
    },
    {
      name: "JavaScript",
      desc: "Works with DOM, events, ES6 and logic building.",
    },
